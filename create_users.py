...
def create_initial_data():
    ...
    for campaign_data in campaigns_data:
        ...
        if not existing:
            ...
            if master and master._oid:
                campaign = Campaign.create(
                    name=name,
                    is_public=campaign_data["is_public"],
                    master_id=str(master._oid),
    ...
    for character_data in characters:
        ...
        if user and user._oid:
            character = Character.create(
                name=character_data["name"],
                race=character_data["race"],
                character_class=character_data["character_class"],
                level=character_data["level"],
                user_id=str(user._oid),
...
if __name__ == "__main__":
    with app.app_context():
        ...
        create_initial_data()
        print("Databse initialized with initial users, campaigns, characters, and missions.")
